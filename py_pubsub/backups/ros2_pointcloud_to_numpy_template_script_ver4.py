'''
alias: ros2_pointcloud_to_numpy_template_script_ver4
...
class ROS2PointCloudToNumpy(Node):
    ...
    def __init__(self):
        ...
        self.vis.create_window("Real-time Point Cloud", width=800, height=600)
    ...
    def listener_callback(self, msg):
        ...
        ###########
        self.pcd.points = o3d.utility.Vector3dVector(xyz_data)
        self.pcd.colors = o3d.utility.Vector3dVector(rgb_colors)
        # Update visualization
        if not self.vis.update_geometry(self.pcd):
            self.vis.add_geometry(self.pcd)
        self.vis.poll_events()
        self.vis.update_renderer()
        
    def destroy_node(self):
        # Close the visualizer when the node is destroyed
